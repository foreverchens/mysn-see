package com.ychen.see.common.enums;
...
public enum IntervalEnum {
    ...
    w1("1w", 1440 * 7),w2("2w", 1440 * 7 * 2), M1("1M", 1440 * 30);

    public String interval;
    public Long time;


    public static java.util.List<IntervalEnum> jqPoolPeriodList;

    static {
        jqPoolPeriodList = java.util.Arrays.asList(d3);
    }
